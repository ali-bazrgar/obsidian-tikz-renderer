...
export default class TikzRendererPlugin extends Plugin {
  ...
  async onload(): Promise<void> {
    ...
    for (const language of ["tikz", "pgfplots", "circuitikz", "tex", "latex"]) {
      this.registerMarkdownCodeBlockProcessor(language, (source, el, ctx) => TikzMarkdownProcessor.process(language, source, el, ctx, this.renderService));
    }
...
export const DEFAULT_SETTINGS: TikzSettings = { engine:"auto",latexPath:"latex",pdflatexPath:"pdflatex",xelatexPath:"xelatex",lualatexPath:"lualatex",dvilualatexPath:"dvilualatex",dvisvgmPath:"dvisvgm",mutoolPath:"mutool",assetFolder:"TikZ Assets",cacheFolder:".tikz-cache",displayTheme:"auto",defaultZoom:100,keepTexSource:false,compileTimeout:30000,persianFont:"Vazirmatn",preamble:DEFAULT_PREAMBLE,historyLimit:20 };
class TikzSettingTab extends PluginSettingTab {
  constructor(app: any, private readonly plugin: TikzRendererPlugin) { super(app, plugin); }
  display(): void {
